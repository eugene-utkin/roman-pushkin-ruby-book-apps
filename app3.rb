puts "Say a note on a 0 fret?" # Подразумевается, что мы скажем E
gets

puts "Say a note on a 1st fret?" # Подразумевается, что мы скажем F
gets

puts "Say a note on a 2nd fret?" # На втором ладу находится нота F#
gets
